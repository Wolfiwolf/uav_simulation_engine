...
// TIME
#define COMMAND_SET_TIMESTAMP 		                    8
// CONTROLS
#define COMMAND_CONTROL_PAN 		                    9
#define COMMAND_CONTROL_ELEVATION 		                10
// STREAMING
#define COMMAND_SET_STREAMING_POSITION                  11
#define COMMAND_SET_STREAMING_ORIENTATION               12
#define COMMAND_SET_STREAMING_GYRO                      13
#define COMMAND_SET_STREAMING_ACCELEROMETER             14
#define COMMAND_SET_STREAMING_MAGNETOMETER              15
#define COMMAND_SET_STREAMING_BAROMETER                 16
// LOGGING
#define COMMAND_LOGGING_DELETE_DATA_LOG                 17
